...
사고 발생 시간, 위치, 기상 조건, 도로 주변 시설 정보를 바탕으로 사고 심각도를 `1`, `2`, `3`, `4`의 네 개 클래스로 분류합니다. 또한 학습된 모델을 활용하여 사용자가 직접 사고 정보를 입력하면 웹 화면에서 예측 결과를 확인할 수 있도록 **Streamlit 기반 예측 웹앱**을 구현했습니다.
